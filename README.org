...
#+BEGIN_SRC sh
     ...
     opam install --jobs=4 coq coq-color coq-ext-lib coq-math-classes coq-dpdgraph coq-template-coq coq-flocq coq-switch ANSITerminal coq-paco coq-itree core core_kernel
#+END_SRC
