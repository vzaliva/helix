...
# coq_makefile CarrierType.v CaseNaming.v CpdtTactics.v HCOLBreakdown.v HCOLImpl.v HCOL.v IndexFunctions.v JRWTactics.v Rtheta.v SigmaHCOLRewriting.v SigmaHCOL.v SpiralTactics.v Spiral.v SVector.v THCOLImpl.v THCOL.v WriterMonadNoT.v 
#
...
.merlin:
	...
	@echo "B /home/lord/src/spiral-coq" >> .merlin
	@echo "S /home/lord/src/spiral-coq" >> .merlin
