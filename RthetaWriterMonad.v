...
Global Instance Rtheta_MLe: Le (flags_m Rtheta) := Rtheta_liftRel (Rtheta_rel_first le).
Global Instance Rtheta_MLt: Lt (flags_m Rtheta) := Rtheta_liftRel (Rtheta_rel_first lt).
