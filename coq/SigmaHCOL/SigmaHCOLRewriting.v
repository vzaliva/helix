...
Section WithCarrierA.
  ...
  Section SigmaHCOLHelperLemmas.
    ...
    Lemma UnSafeCast_SHCompose
          {i1 o2 o3: nat}
          (F: @SHOperator CADEFS Monoid_RthetaFlags o2 o3 svalue)
          (G: @SHOperator CADEFS Monoid_RthetaFlags i1 o2 svalue)
      :
    ...
    Lemma SafeCast_SHCompose
          {i1 o2 o3: nat}
          (F: @SHOperator CADEFS _ o2 o3 svalue)
          (G: @SHOperator CADEFS _ i1 o2 svalue)
      :
    ...
    Lemma SafeCast_SHBinOp
          ...
          `{pF: !Proper ((=) ==> (=) ==> (=) ==> (=)) f}
      :
        SafeCast (@SHBinOp CADEFS CAPROPS Monoid_RthetaSafeFlags svalue o f pF) =
        @SHBinOp CADEFS CAPROPS Monoid_RthetaFlags svalue o f pF.
    Proof.
      unfold_RStheta_equiv.
      unfold SHOperator_equiv, SafeCast.
      unfold SafeCast', compose.
    ...
    Lemma SafeCast_SHPointwise
          ...
          `{f_mor: !Proper ((=) ==> (=) ==> (=)) f}
      :
        SafeCast (@SHPointwise CADEFS Monoid_RthetaSafeFlags svalue n f f_mor) =
        @SHPointwise CADEFS Monoid_RthetaFlags svalue n f f_mor.
    Proof.
      unfold_RStheta_equiv.
      unfold SHOperator_equiv, SafeCast.
      unfold SafeCast', compose.
    ...
    Lemma SafeCast_GathH
      ...
      :
        SafeCast (@GathH CADEFS Monoid_RthetaSafeFlags svalue i o base stride domain_bound) =
        @GathH CADEFS Monoid_RthetaFlags svalue i o base stride domain_bound.
    Proof.
      unfold_RStheta_equiv.
      unfold SHOperator_equiv, SafeCast.
      unfold SafeCast', compose.
    ...
    Section WithMonoid.
      ...
      Lemma LiftM_Hoperator_compose
            {i1 o2 o3: nat}
            `{@HOperator CADEFS  o2 o3 op1}
            `{@HOperator CADEFS  i1 o2 op2}
        :
      ...
      Proof.
        ...
        -
          ...
          +
            ...
            setoid_replace (UnionFold fm plus zero x0) with (@mkSZero _ fm)
          ...
          +
            ...
            setoid_replace h with (@mkSZero _ fm) by apply Is_ValZero_to_mkSZero, HS.
            apply Union_SZero_r.
      ...
      Lemma UnSafeCast_SHBinOp
            ...
            `{pF: !Proper ((=) ==> (=) ==> (=) ==> (=)) f}
        :
          UnSafeCast (@SHBinOp CADEFS CAPROPS _ svalue o f pF) =
          @SHBinOp CADEFS CAPROPS _ svalue o f pF.
      Proof.
        unfold_RStheta_equiv.
        unfold SHOperator_equiv, UnSafeCast.
        unfold UnSafeCast', compose.
    ...
    BinOp := (self, o, opts) >> When(o.N=1, o, let(i := Ind(o.N),
      ...
      Proof.
        ...
        -
          ...
          rewrite <- (@AbsorbISumUnionIndex_Vbuild CADEFS).
  ...
  Section SigmaHCOLRewritingRules.
    Section Value_Correctness.
      ...
      Local Notation "g ⊚ f" := (@SHCompose CADEFS CAPROPS Monoid_RthetaFlags _ _ _ _ g f) (at level 40, left associativity) : type_scope.

      Theorem rewrite_PointWise_ISumUnion
              {i o n: nat}
              (op_family: @SHOperatorFamily CADEFS Monoid_RthetaFlags i o n zero)
        ...
        :
          (@SHPointwise CADEFS Monoid_RthetaFlags zero o pf pf_mor) ⊚ (@ISumUnion CADEFS CAPROPS i o n op_family) =
          (@ISumUnion CADEFS CAPROPS i o n
                      (SHOperatorFamilyCompose _
                                               (@SHPointwise CADEFS _ _ o pf pf_mor)
                                               op_family)
          ).
      Proof.
            ...
            set (vl:=(@Vbuild (Rtheta' Monoid_RthetaFlags) n
                              (fun (z : nat) (zi : Peano.lt z n) =>
                                 @Vnth (Rtheta' Monoid_RthetaFlags) o
                                       (@get_family_op _ Monoid_RthetaFlags i o n _ op_family z zi x) j jc))).
            intros Uzeros.
            ...
            assert(H: UnionFold _ plus zero vr = mkSZero).
            {
                                 ...
                                 jc))) = szero_svector Monoid_RthetaFlags n).
              {
                ...
                setoid_replace (Vnth
                                  ...
                                  jc) with (@mkSZero _ Monoid_RthetaFlags).
                -
                  rewrite evalWriter_Rtheta_SZero.
                  rewrite pfzn.
                  unfold_Rtheta_equiv.
      ...
      Lemma Diamond_f_subst
            ...
            (op_family: @SHOperatorFamily _ Monoid_RthetaFlags i o n uf_zero)
      ...
      Theorem rewrite_Reduction_IReduction
              ...
              (Uz: Apply_Family_Single_NonUnit_Per_Row _ op_family)
              (Upoz: Apply_Family_Vforall_P _ (liftRthetaP P) op_family)
              `{u_scompat: @BFixpoint CADEFS uf_zero u}
              `{f_scompat: @BFixpoint CADEFS uf_zero f}
              {u_mor: Proper ((=) ==> (=) ==> (=)) u}
              {f_mor: Proper ((=) ==> (=) ==> (=)) f}
        :
...
and `ISumReduction_PointWise` *)
      Theorem rewrite_IReduction_absorb_operator
              ...
              (f: CarrierA -> CarrierA -> CarrierA)
              (f_mor: Proper (equiv ==> equiv ==> equiv) f)
              (F: @SHOperatorFamily _ Monoid_RthetaSafeFlags i o n z)
              (G: @SHOperator _ Monoid_RthetaSafeFlags i0 i z)
              `{scompat: @BFixpoint CADEFS z f}
        :
          SHCompose _
                    (@IReduction _ _ z i o n f _ scompat F)
                    G
          =
          @IReduction _ _ z i0 o n f _ scompat
     ...
     see if there is a Monoid-like alebraic structure [(A,pf,svalue)] *)
      Theorem rewrite_PointWise_ScatHUnion
              ...
              {n i o ki ko}
              (* Kernel *)
              (kernel: @SHOperatorFamily _ fm ki ko n zero)
              (* Scatter index map *)
      ...
      Theorem rewrite_GathH_GathH
        ...
        :
          SHCompose fm
                    (@GathH _ fm svalue t o b0 s0 bound0)
                    (@GathH _ fm svalue i t b1 s1 bound1)
          =
    ...
    SHBinOp fm (SwapIndex2 j (IgnoreIndex2 sub))
      ...
      Definition Pickn
                 ...
                 {svalue: CarrierA}
                 (n:nat)
        : @SHOperatorFamily _ fm n 1 n svalue := fun jf => Pick _ (proj2_sig jf).
      ...
      Theorem terminate_Reduction
              ...
              (idv: CarrierA)
              `{scompat : @BFixpoint CADEFS idv f}
        :
      ...
      Theorem terminate_GathH1
        ...
        :
          @GathH _ fm svalue i 1 base stride domain_bound = @Pick _ fm svalue i base (GathH1_domain_bound_to_base_bound domain_bound).
      Proof.
        unfold GathH.
        unfold equiv, SHOperator_equiv.
        unfold equiv, ext_equiv.
      ...
      Lemma Rtheta'_lift_Monoid
        ...
        :
          @abstract_algebra.Monoid (Rtheta' Monoid_RthetaFlags)
                                   (@Rtheta'_equiv _ Monoid_RthetaFlags)
      ...
      Lemma terminate_GathHN_generic
            ...
            `{scompat : @BFixpoint CADEFS z f}
        :
          @GathH _ _ z i o base stride domain_bound
          =
          @IUnion _ _ z i o o f _ _ (fun jf =>
                                   SHCompose _
                                             (@Embed _ _ _ z o (proj1_sig jf) (proj2_sig jf))
                                             (@Pick _ _ z i (base+(proj1_sig jf)*stride) (domain_bound (proj1_sig jf) (proj2_sig jf))
                                             )
                                ).
      Proof.
        unfold GathH.
      ...
      Theorem terminate_GathHN
              ...
              {domain_bound: ∀ x : nat, x < o → base + x * stride < i}
        :
          @GathH _ _ zero i o base stride domain_bound
          =
          @ISumUnion _ _ i o o  (fun jf =>
                               SHCompose _
                                         (@Embed _ _  _ zero o _ (proj2_sig jf))
                                         (@Pick _ _ zero i (base+(proj1_sig jf)*stride) (domain_bound _ (proj2_sig jf))
                                         )
                            ).
      Proof.
