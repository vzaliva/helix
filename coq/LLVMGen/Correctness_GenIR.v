...
Axiom int_eq_inv: forall a b, Int64.intval a ≡ Int64.intval b -> a ≡ b.
  ...
  Definition bid_bound_between (s1 s2 : IRState) (bid : block_id) : Prop
    := exists name s' s'', not_ends_with_nat name /\ block_count s' ≥ block_count s1 /\ (block_count s' < block_count s2)%nat /\ inr (s'', bid) ≡ incBlockNamed name s'.
 ...
 Proof.
    ...
    - cbn* in GEN.
      ...
      2 : {
        ...
        eapply bid_bound_incBlockNamed in Heqs.
